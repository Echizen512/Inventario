            ...
            if (response != 0) {
                ...
                var myPieChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: cantidad,
                            backgroundColor: ['#AEC6CF', '#FFB6C1', '#FFDDC1', '#E6E6FA', '#D8BFD8', '#B0E0E6', '#AFEEEE', '#E0FFFF', '#FFFFCC', '#FFFACD'],
                        }],
                    },
                });
            }
            ...
            if (response != 0) {
                ...
                var myPieChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: cantidad,
                            backgroundColor: ['#D8BFD8', '#E6E6FA', '#FFFACD', '#E0FFFF', '#FFDDC1', '#AEC6CF', '#AFEEEE', '#B0E0E6', '#FFB6C1', '#FFFFCC'],
                        }],
                    },
                });
            }
